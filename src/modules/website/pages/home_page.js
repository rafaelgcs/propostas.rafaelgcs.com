    ...
    return (
        <div className="about-us">
            <nav class="navbar navbar-expand-lg position-absolute top-0 z-index-3 w-100 shadow-none my-3  navbar-transparent ">
                        ...
                        <ul class="navbar-nav navbar-nav-hover w-100">
                            <li class="nav-item dropdown dropdown-hover mx-2 ms-lg-6">
                                <a class="nav-link ps-2 d-flex justify-content-between cursor-pointer align-items-center" id="dropdownMenuPages" data-bs-toggle="dropdown" aria-expanded="false">
                                    {"Pages"}
                                    <img src={defaultImages.arrow.down.white} alt="down-arrow" class="arrow ms-1 d-lg-block d-none" />
                                    <img src={defaultImages.arrow.down.dark} alt="down-arrow" class="arrow ms-1 d-lg-none d-block" />
                                </a>
                                            ...
                                            <a class="dropdown-item py-2 ps-3 border-radius-md" href="../presentation.html">
                                                <div class="d-flex">
                                                    ...
                                                    <div class="w-100 d-flex align-items-center justify-content-between">
                                                        ...
                                                        <img src={defaultImages.arrow.down.default} alt="down-arrow" class="arrow" />
                                                    </div>
                                                </div>
                                            </a>
               ...
               <img src={defaultImages.arrow.down.white} alt="down-arrow" class="arrow ms-1 d-lg-block d-none" />
                                        ...
                                        <ul class="list-group">
                                            <li class="nav-item list-group-item border-0 p-0">
                                                <a class="dropdown-item py-2 ps-3 border-radius-md" href=" https://www.creative-tim.com/learning-lab/bootstrap/license/soft-ui-design-system ">
                                                    <div class="d-flex">
                                                        <div class="icon h-10 me-3 d-flex mt-1">
                                                            <svg class="text-secondary" width="16px" height="16px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <li class="nav-item list-group-item border-0 p-0">
                                                <a class="dropdown-item py-2 ps-3 border-radius-md" href="  ">
                                                    <div class="d-flex">
                                                        <div class="icon h-10 me-3 d-flex mt-1">
                                                            <svg class="text-secondary" width="16px" height="16px" viewBox="0 0 40 44" version="1.1" xmlns="http://www.w3.org/2000/svg">
                                            ...
                                            <li class="nav-item list-group-item border-0 p-0">
                                                <a class="dropdown-item py-2 ps-3 border-radius-md" href="  ">
                                                    <div class="d-flex">
                                                        <div class="icon h-10 me-3 d-flex mt-1">
                                                            <svg class="text-secondary" width="16px" height="16px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <li class="nav-item my-auto ms-3 ms-lg-0">
                                <a href="https://www.creative-tim.com/product/soft-ui-design-system-pro" class="btn btn-sm  bg-white  btn-round mb-0 me-1 mt-2 mt-md-0">Upgrade to Pro</a>
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <header class="bg-dark">
                <div class="page-header section-height-75" style={{ backgroundImage: `url(${defaultImages.office.dark})` }}>
                    ...
                    <div class="position-absolute w-100 z-index-1 bottom-0">
                        ...
                        {/* <img src={shapes.waves.manyWhite} /> */}
                        {/* <svg class="waves" xmlns="http://www.w3.org/2000/svg" viewBox="0 24 150 40" preserveAspectRatio="none" shape-rendering="auto">
                            ...
                            <g class="moving-waves">
                                <use x="48" y="-1" fill="rgba(255,255,255,0.40" />
                                <use x="48" y="3" fill="rgba(255,255,255,0.35)" />
                                <use x="48" y="5" fill="rgba(255,255,255,0.25)" />
                                <use x="48" y="8" fill="rgba(255,255,255,0.20)" />
                                <use x="48" y="13" fill="rgba(255,255,255,0.15)" />
                                <use x="48" y="16" fill="rgba(255,255,255,1" />
                            </g>
                        </svg> */}
                    </div>
                </div>
                        ...
                        <div class="col-lg-4 ms-auto mt-lg-0 mt-4">
                            <div class="card shadow-lg">
                                <div class="card-header p-0 mx-3 mt-3 position-relative z-index-1">
                                    ...
                                    <div class="colored-shadow" style={{ backgroundImage: `url(&quot;https://raw.githubusercontent.com/creativetimofficial/public-assets/master/soft-ui-design-system/assets/img/funny.jpg&quot;)` }}></div>
                                </div>
                                <div class="card-body">
                                    <a href="javascript:;">
                                        <h5 class="mt-3">
                                    ...
                                    <div class="col-lg-4 col-md-6 col-12 pe-lg-0">
                                        <a href="javascript:;">
                                            <div class="p-3 pe-md-0">
                                                <img class="w-100 border-radius-md" src={people.kalVisuals} alt="image" />
                                            </div>
                                        </a>
                                    </div>
                            ...
                            <div class="card card-profile mt-lg-0 mt-5 overflow-hidden">
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 col-12 pe-lg-0">
                                        <a href="javascript:;">
                                            <div class="p-3 pe-md-0">
                                                <img class="w-100 border-radius-md" src={people.bruceMars} alt="image" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
                            ...
                            <div class="card card-profile overflow-hidden z-index-2">
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 col-12 pe-lg-0">
                                        <a href="javascript:;">
                                            <div class="p-3 pe-md-0">
                                                <img class="w-100 border-radius-md" src={defaultImages.team4} alt="image" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
                            ...
                            <div class="card card-profile mt-lg-0 mt-5 overflow-hidden z-index-2">
                                <div class="row">
                                    <div class="col-lg-4 col-md-6 col-12 pe-lg-0">
                                        <a href="javascript:;">
                                            <div class="p-3 pe-md-0">
                                                <img class="w-100 border-radius-md" src={people.ivana} alt="image" />
                                            </div>
                                        </a>
                                    </div>
                                    <div class="col-lg-8 col-md-6 col-12 ps-lg-0 my-auto">
                ...
                <div class="container">
                    <div class="row mb-7">
                        <div class="col-lg-2 col-md-4 col-6 mb-4">
                            <img class="w-100 opacity-7" src={logos.gray.coinbase} alt="logo" />
                        </div>
                        <div class="col-lg-2 col-md-4 col-6 mb-4">
                            <img class="w-100 opacity-7" src={logos.gray.nasa} alt="logo" />
                        </div>
                        <div class="col-lg-2 col-md-4 col-6 mb-4">
                            <img class="w-100 opacity-7" src={logos.gray.netflix} alt="logo" />
                        </div>
                        <div class="col-lg-2 col-md-4 col-6 mb-4">
                            <img class="w-100 opacity-7" src={logos.gray.pinterest} alt="logo" />
                        </div>
                        <div class="col-lg-2 col-md-4 col-6 mb-4">
                            <img class="w-100 opacity-7" src={logos.gray.spotify} alt="logo" />
                        </div>
                        <div class="col-lg-2 col-md-4 col-6 mb-4">
                            <img class="w-100 opacity-7" src={logos.gray.vadafone} alt="logo" />
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-5 ms-auto">
                            <div class="position-relative">
                                <img class="max-width-50 w-100 position-relative z-index-2" src={illustrations.signUp} alt="image" />
                            </div>
                        </div>
                    </div>
                </div>
