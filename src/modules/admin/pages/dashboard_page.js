    ...
    useEffect(() => {
        const startCharts = () => {
            let optionsActiveUsers = {
                series: [{
                    name: "",
                    data: [450, 200, 100, 220, 500, 100, 400, 230, 520]
                }],
                chart: {
                    height: 200,
                    type: 'bar',
            ...
            let chartActiveUsers = new ApexCharts(document.querySelector(".active_users_chart"), optionsActiveUsers);

            chartActiveUsers.render();

            let chartSales = new ApexCharts(document.querySelector(".chart_sales"), optionsSales);
    ...
    return (
        <div className={`g-sidenav-show bg-gray-100${showNavbar ? " g-sidenav-pinned" : ""}`}>
            ...
            <main className="main-content mt-1 border-radius-lg">
                <TopNavigator title="Dashboard" showDrawer={onChangeDrawer} showNavbar={onChangeNavbar} navbarOpen={showNavbar} />
                                    ...
                                    <div className="row">
                                        <div className="col-lg-6">
                                            <div className="d-flex flex-column h-100">
                                                ...
                                                <a className="text-body text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="#" onClick={() => onChangeDrawer(true)}>
                                                    Read More
                            ...
                            <div className="card">
                                <div className="card-body p-3">
                                    <div className="bg-gradient-dark border-radius-lg py-3 pe-1 mb-3">
                                        <div className="active_users_chart"></div>
                                    </div>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <div className="d-flex px-2 py-1">
                                                            <div>
                                                                <img src={smallLogos.xd} className="avatar avatar-sm me-3" />
                                                            </div>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div className="d-flex px-2 py-1">
                                                            <div>
                                                                <img src={smallLogos.atlassian} className="avatar avatar-sm me-3" />
                                                            </div>
                                                            <div className="d-flex flex-column justify-content-center">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div className="d-flex px-2 py-1">
                                                            <div>
                                                                <img src={smallLogos.slack} className="avatar avatar-sm me-3" />
                                                            </div>
                                                            <div className="d-flex flex-column justify-content-center">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div className="d-flex px-2 py-1">
                                                            <div>
                                                                <img src={smallLogos.spotify} className="avatar avatar-sm me-3" />
                                                            </div>
                                                            <div className="d-flex flex-column justify-content-center">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div className="d-flex px-2 py-1">
                                                            <div>
                                                                <img src={smallLogos.jira} className="avatar avatar-sm me-3" />
                                                            </div>
                                                            <div className="d-flex flex-column justify-content-center">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div className="d-flex px-2 py-1">
                                                            <div>
                                                                <img src={smallLogos.invision} className="avatar avatar-sm me-3" />
                                                            </div>
                                                            <div className="d-flex flex-column justify-content-center">
