...
const BillingPage = () => {
    ...
    return (
        <div className="g-sidenav-show   bg-gray-100">
            <Sidebar logo={logos.navbar} />
            <main class="main-content mt-1 border-radius-lg">
                <TopNavigator title="Billing" showDrawer={onChangeDrawer} />
                            ...
                            <div class="row">
                                <div class="col-xl-6 mb-xl-0 mb-4">
                                    <div class="card bg-transparent shadow-xl">
                                        <div class="overflow-hidden position-relative border-radius-xl" style={{ backgroundImage: `url('../assets/img/curved-images/curved14.jpg')` }}>
